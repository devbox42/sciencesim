...
\hline
B1 & Radfahrer: $s = 200$\,m, $t = 40$\,s. Berechne $v$. & \vspace{1.3cm} \\
\hline
B2 & Jogger: $v = 4$\,\si{\metre\per\second}, $s = 200$\,m. Berechne $t$. & \vspace{1.3cm} \\
\hline
B3 & Skater: $v = 6$\,\si{\metre\per\second}, $t = 30$\,s. Berechne $s$. & \vspace{1.3cm} \\
\hline
B4 & Schwimmer: $s = 150$\,m, $t = 30$\,s. Berechne $v$. & \vspace{1.3cm} \\
\hline
B5 & Läufer: $v = 8$\,\si{\metre\per\second}, $s = 160$\,m. Berechne $t$. & \vspace{1.3cm} \\
\hline
B6 & Bus: $v = 5$\,\si{\metre\per\second}, $t = 40$\,s. Berechne $s$. & \vspace{1.3cm} \\
\hline
\end{tabular}
}
...
a) Weg nach $t = 4$\,s: \quad $s$ = \hspace{1.5cm}

\vspace{0.6em}
b) Zeit bei $s = 60$\,m: \quad $t$ = \hspace{1.5cm}

\vspace{0.6em}
c) Weg nach $t = 2$\,s: \quad $s$ = \hspace{1.5cm}

\vspace{0.6em}
d) Zeit bei $s = 80$\,m: \quad $t$ = \hspace{1.5cm}
\end{minipage}
...
\hline
D1 & 5\,\si{\metre\per\second} & & --- & --- \\
\hline
D2 & 10\,\si{\metre\per\second} & & 10\,m & \\
\hline
D3 & 8\,\si{\metre\per\second} & & 8\,m & \\
\hline
D4 & 15\,\si{\metre\per\second} & & 15\,m & \\
\hline
D5 & 12\,\si{\metre\per\second} & & 12\,m & \\
\hline
\end{tabular}
}
