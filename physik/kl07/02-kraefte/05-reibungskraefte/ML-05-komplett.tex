...
$F_\text{N}$ & = Normalkraft in \lsg{N (Newton)} (auf ebener Fläche $\approx$ Gewichtskraft) \\
\end{tabular}
...
\lsg{Je weniger Reibung zwischen Reifen und Straße, desto länger der Bremsweg.}

\lsg{Auf Eis ist die Reibungszahl $\mu$ sehr klein, daher ist die Bremskraft gering.}
\end{protokollbox}
