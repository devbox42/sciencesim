...
\section*{\textcolor{trackpadpurple}{Trackpad oder Maus}}
...
\fcolorbox{trackpadpurple}{trackpadpurple!8}{%
\begin{minipage}{0.93\linewidth}
\vspace{1mm}
\textbf{Alternative: Normale Maus!}\\
Wer mit dem Trackpad nicht zurechtkommt, kann jede USB- oder Bluetooth-Maus anschließen -- funktioniert sofort!
\vspace{1mm}
\end{minipage}}
...
\begin{minipage}{0.95\linewidth}
\vspace{2mm}
\textbf{\textcolor{macgray}{BASIS -- Das sollte jeder können:}}
\begin{itemize}[label=$\square$, itemsep=2pt]
\item Ich weiß, wo die \textbf{Menüleiste} ist und was das Apfel-Menü enthält
\item Ich weiß, was das \textbf{Dock} ist und kann Programme starten
\item Ich kann mit \taste{cmd}+\taste{Leertaste} die \textbf{Spotlight-Suche} öffnen
\end{itemize}
\vspace{2mm}
\end{minipage}}
\end{center}
...
\begin{minipage}{0.95\linewidth}
\vspace{2mm}
\textbf{\textcolor{finderblue}{VERTIEFUNG -- Für Fortgeschrittene:}}
\begin{itemize}[label=$\square$, itemsep=2pt]
\item Ich kann den \textbf{Finder} öffnen und Dateien finden
\item Ich kenne die wichtigen Ordner (Dokumente, Downloads...)
\item Ich kann mit \textbf{Trackpad oder Maus} navigieren
