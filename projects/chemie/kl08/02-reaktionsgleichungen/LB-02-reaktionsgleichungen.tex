...
\abschnitt{Wertigkeit – Die \glqq{}Händezahl\grqq{}}
...
\vspace{6pt}
{\footnotesize
\textbf{Warum funktioniert das? Elektronen-Bilanz:}\\
Al gibt 3 e$^-$ ab, O nimmt 2 e$^-$ auf.\\
Damit es aufgeht: 2 Al geben $2 \times 3 = 6$ e$^-$ ab,\\
3 O nehmen $3 \times 2 = 6$ e$^-$ auf. $\checkmark$
}
...
\textbf{4.} & \textbf{Vorfaktoren ausgleichen} (schrittweise mit Atombilanz): \\[0.8em]
%
& \textbf{Start:} Atome zählen – noch nicht ausgeglichen! \\[0.3em]
& \hspace{1.2em}\begin{tabular}[t]{@{}c@{}c@{}c@{}c@{}c@{}}
Li & $\;+\;$ & O\textsubscript{2} & $\;\rightarrow\;$ & Li\textsubscript{2}O \\[-0.2em]
{\scriptsize\textcolor{metall}{1}} & & {\scriptsize\textcolor{sauerstoff}{2}} & & {\scriptsize\textcolor{metall}{2}\hspace{0.8em}\textcolor{sauerstoff}{1}}
\end{tabular} \quad $\Rightarrow$ \textbf{nicht gleich!} \\[1em]
%
& a) \textcolor{fachfarbe}{\textbf{Produkt verdoppeln:}} O-Anzahl rechts soll gerade sein. \\[0.3em]
& \hspace{1.2em}\begin{tabular}[t]{@{}c@{}c@{}c@{}c@{}c@{}}
Li & $\;+\;$ & O\textsubscript{2} & $\;\rightarrow\;$ & \textcolor{fachfarbe}{\textbf{2}}\,Li\textsubscript{2}O \\[-0.2em]
{\scriptsize\textcolor{metall}{1}} & & {\scriptsize\textcolor{sauerstoff}{2}} & & {\scriptsize\textcolor{metall}{4}\hspace{0.8em}\textcolor{sauerstoff}{2}}
\end{tabular} \quad O: 2=2 \checkmark \\[1em]
%
& b) \textcolor{metall}{\textbf{Metall anpassen:}} Li links = Li rechts? 4 Li nötig! \\[0.3em]
& \hspace{1.2em}\begin{tabular}[t]{@{}c@{}c@{}c@{}c@{}c@{}}
\textcolor{metall}{\textbf{4}}\,Li & $\;+\;$ & O\textsubscript{2} & $\;\rightarrow\;$ & \textcolor{fachfarbe}{\textbf{2}}\,Li\textsubscript{2}O \\[-0.2em]
{\scriptsize\textcolor{metall}{4}} & & {\scriptsize\textcolor{sauerstoff}{2}} & & {\scriptsize\textcolor{metall}{4}\hspace{0.8em}\textcolor{sauerstoff}{2}}
\end{tabular} \quad Li: 4=4 \checkmark \\[1em]
%
& \textbf{Ergebnis:} \fbox{\textbf{4 Li + O\textsubscript{2} $\rightarrow$ 2 Li\textsubscript{2}O}} \quad Kontrolle: Li 4=4, O 2=2 \checkmark \\
\end{tabular}
\end{algorithmusbox}
...
\begin{itemize}[leftmargin=1.2em, itemsep=0pt, topsep=2pt]
    \item \textbf{Wertigkeit} = Anzahl der möglichen Bindungen (\glqq{}Händezahl\grqq{}) = Elektronen, die abgegeben/aufgenommen werden
