% ============================================================================
% LANGENTWURF: Mi instituto - Objetos de clase & hay
% Klasse 7 | Spanisch | Doppelstunde (90 Min.)
% ============================================================================
% DS 01 | Unidad 2 | Mi instituto
...
\fancyhead[R]{\small\textcolor{gray}{Langentwurf Tier 1 -- DS 01}}
...
Arbeitsblatt (AB-01) & Festigung, Hausaufgabe \\
Lernpfad (LP-01) & Digitale Übung (optional) \\
\hline
\end{tabular}
...
25--37 & Festigung & Verteilt Arbeitsblatt, erklärt Aufgaben, unterstützt individuell & AB bearbeiten (Aufg. 1--4) & EA & AB-01 \\
\hline
...
\begin{itemize}
    ...
    \item \textbf{Optional:} Lernpfad LP-01 bearbeiten (digital)
...
\begin{enumerate}
    \item \textbf{AB-01.pdf} -- Arbeitsblatt (Klassensatz)
    \item \textbf{ML-01.pdf} -- Musterlösung
    \item \textbf{LP-01.html} -- Digitaler Lernpfad
