% ═══════════════════════════════════════════════════════════════
% MT-08a: Minitest Viajar - Verkehrsmittel
% Spanisch Klasse 7
% ═══════════════════════════════════════════════════════════════
% Dauer: 15 Minuten
% Punkte: 26 BE
...
\newcommand{\thema}{Minitest: Viajar -- Verkehrsmittel}
...
\begin{center}
\begin{tabular}{rcl}
\es{el avión} & \luecke{2cm} & das Schiff \\[0.8em]
\es{el tren} & \luecke{2cm} & das Flugzeug \\[0.8em]
\es{el coche} & \luecke{2cm} & der Bus \\[0.8em]
\es{el autobús} & \luecke{2cm} & der Zug \\[0.8em]
\es{el barco} & \luecke{2cm} & das Fahrrad \\[0.8em]
\es{la bicicleta} & \luecke{2cm} & das Auto \\
\end{tabular}
\end{center}
...
\noindent
a) Voy a Mallorca \luecke{4cm}. \hfill (Flugzeug)

\vspace{0.8em}

\noindent
b) Vamos a París \luecke{4cm}. \hfill (Zug)

\vspace{0.8em}

\noindent
c) Viajo a la playa \luecke{4cm}. \hfill (Auto)

\vspace{0.8em}

\noindent
d) Vamos a las islas \luecke{4cm}. \hfill (Schiff)
...
\noindent
a) Yo \luecke{5cm} en la playa. \hfill (schwimmen)
...
\noindent
c) Tú \luecke{5cm} senderismo. \hfill (machen)

\vspace{0.8em}

\noindent
d) Ellos \luecke{5cm} el sol. \hfill (sich sonnen)
...
\begin{center}
\begin{tabular}{rcl}
\es{la playa} & \luecke{2cm} & hacer senderismo \\[0.8em]
\es{la montaña} & \luecke{2cm} & nadar, tomar el sol \\[0.8em]
\es{el hotel} & \luecke{2cm} & hacer una barbacoa \\[0.8em]
\es{el camping} & \luecke{2cm} & descansar \\
\end{tabular}
\end{center}
...
\noindent
a) Yo \luecke{2.5cm} a la playa.

\vspace{0.8em}

\noindent
b) Tú \luecke{2.5cm} a España.

\vspace{0.8em}

\noindent
c) Ella \luecke{2.5cm} a la montaña.

\vspace{0.8em}

\noindent
d) Nosotros \luecke{2.5cm} de vacaciones.
