% ═══════════════════════════════════════════════════════════════
% SL-02d: Stundenleistung Sequenz 2 - Mi familia
% Spanisch Klasse 7
% ═══════════════════════════════════════════════════════════════
% Dauer: 25 Minuten
% Punkte: 20
...
% ═══════════════════════════════════════════════════════════════
% AUFGABE 1: Zuordnung Familienmitglieder
% ═══════════════════════════════════════════════════════════════
...
\es{el tío} & \luecke{2cm} & der Onkel \\
\end{tabular}
\end{center}
...
\noindent
c) Nosotros \luecke{2.5cm} una casa grande. \hfill (wir haben)

\vspace{0.8em}

\noindent
d) ¿Tú \luecke{2.5cm} primos? \hfill (hast du?)

\vspace{15pt}

% ═══════════════════════════════════════════════════════════════
% AUFGABE 3: Possessivbegleiter + Zahlen
% ═══════════════════════════════════════════════════════════════
...
\noindent
a) \luecke{2cm} madre tiene 45 años. \hfill (meine Mutter)

\vspace{0.8em}

\noindent
b) ¿Cuántos años tiene \luecke{2cm} hermano? \hfill (dein Bruder)

\vspace{0.8em}

\noindent
c) \luecke{2cm} abuelos viven en España. \hfill (unsere Großeltern)

\vspace{0.8em}

\noindent
d) Mi hermana tiene \luecke{2cm} años. \hfill (zwölf)

\vspace{0.8em}

\noindent
e) \luecke{2cm} primos tienen \luecke{2cm} años. \hfill (seine Cousins / fünfzehn)
