...
\textit{Tipps: Wellenlänge und Spannung können direkt eingetippt werden (Klick aufs Zahlenfeld). Die Spannung lässt sich so feiner einstellen als mit dem Regler. Bei manchen Wellenlängen gibt es keinen Photoeffekt -- trage dann ,,---'' ein.}
