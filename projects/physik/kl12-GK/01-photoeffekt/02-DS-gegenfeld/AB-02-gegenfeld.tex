...
Steigung: $m = \dfrac{\Delta E}{\Delta f} = \dfrac{E_2 - E_1}{f_2 - f_1} = $ \underline{\hspace{4cm}} $= $ \underline{\hspace{2cm}} \si{eV.s}
...
\vspace{0.3em}
Relative Abweichung: $\dfrac{|h_{\text{exp}} - h_{\text{lit}}|}{h_{\text{lit}}} \cdot 100\% = $ \underline{\hspace{3cm}}
...
\vspace{0.3em}
$f_G = $ \underline{\hspace{2cm}} $\cdot 10^{14}$ Hz \quad (= \textbf{Grenzfrequenz} von Natrium)

\vspace{0.5em}
\textit{Physikalische Bedeutung:} \underline{\hspace{8cm}}
...
\vspace{0.3em}
$W_A = $ \underline{\hspace{6cm}} $\approx$ \underline{\hspace{2cm}} eV

\vspace{0.5em}
(Literaturwert Natrium: $W_A = \SI{2,3}{eV}$)
