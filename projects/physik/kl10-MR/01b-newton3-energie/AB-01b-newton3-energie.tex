...
Kräfte treten immer \luecke{2.5cm} auf.

\vspace{6pt}
\textbf{Drei Eigenschaften jedes Kräftepaares:}
\begin{enumerate}[leftmargin=2em, itemsep=2pt]
    \item Gleich \luecke{2cm} (|$F_1$| = |$F_2$|)
    \item Entgegengesetzt \luecke{2.5cm}
    \item Wirken an \luecke{3cm} Körpern!
\end{enumerate}
\end{merkkasten}
...
\begin{tikzpicture}[scale=0.9]
    ...
    % Platz für Pfeile
    \node[gray] at (1.5, 0.5) {\tiny $F_1$: ?};
    \node[gray] at (1.5, 1.4) {\tiny $F_2$: ?};
\end{tikzpicture}
\end{center}
\vspace{0.3em}
...
\begin{tikzpicture}[scale=0.8]
    ...
    \node at (3,-1) {\tiny Gas};
    % Platz für Pfeile
    \node[gray] at (4.8, -0.5) {\tiny $F_1$: ?};
    \node[gray] at (4.8, 2.5) {\tiny $F_2$: ?};
\end{tikzpicture}
\end{center}
\vspace{0.3em}
...
\begin{tikzpicture}[scale=0.8]
    ...
    % Platz für Pfeile
    \node[gray] at (2.8, -0.7) {\tiny $F_1$: ?};
    \node[gray] at (5.2, 0.8) {\tiny $F_2$: ?};
\end{tikzpicture}
\end{center}
...
$g$ & Ortsfaktor: \textbf{\luecke{1.5cm} m/s²} (auf der Erde) \\[4pt]
...
\vspace{0.3em}
\textit{Gegeben:} \luecke{4cm}

\vspace{0.3em}
\textit{Gesucht:} \luecke{2cm}
...
\vspace{0.3em}
\begin{center}
\small\textcolor{mittelgrau}{Gesamt: \_\_\_ / \maxpunkte{} BE}
\end{center}
