...
\begin{center}
    ...
    \begin{minipage}[c]{0.15\textwidth}
        \raggedleft
        \qrcode[height=1.4cm]{https://devbox42.github.io/sciencesim/physik/kl10-MR/05-schwingungen-wellen/LP-05a-schwingungen.html}\\[-2pt]
        {\tiny\textcolor{mittelgrau}{Lernpfad}}
    \end{minipage}
\end{center}
\vspace{-0.3em}
\hrule
