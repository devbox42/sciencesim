% ═══════════════════════════════════════════════════════════════════════════
% QR-CODE: Lernpfad Grundgesetz der Mechanik (Beamer-Projektion)
% Physik Klasse 10 MR
% ═══════════════════════════════════════════════════════════════════════════
...
\newcommand{\lptitel}{Grundgesetz der Mechanik}

\newcommand{\lpurl}{https://devbox42.github.io/sciencesim/physik/kl10-MR/01a-grundgesetz-mechanik/LP-01a-grundgesetz-mechanik.html}
