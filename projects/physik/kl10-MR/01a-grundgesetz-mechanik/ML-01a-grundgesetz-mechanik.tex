% ═══════════════════════════════════════════════════════════════
% ML-01a: Musterlösung - Grundgesetz der Mechanik (F = m · a)
% Physik Klasse 10 MR
% ═══════════════════════════════════════════════════════════════
...
\lhead{\small \fach{} Klasse \klasse{} | \thema{} \textcolor{loesung}{| MUSTERLÖSUNG}}
...
Die \textbf{resultierende Kraft} ist die \lsg{Summe} aller auf einen Körper wirkenden Kräfte.

\vspace{0.3em}
Kräfte in dieselbe Richtung werden \lsg{addiert}.

Kräfte in entgegengesetzte Richtung werden \lsg{subtrahiert}.
\end{merkkasten}
...
\vspace{0.3em}
\textbf{Beobachtung:} Die Kiste mit der größeren Kraft beschleunigt \lsg{schneller}.

\vspace{0.3em}
\textbf{Erkenntnis:} Je größer die \textbf{Kraft}, desto \lsg{größer} die Beschleunigung.
\end{merkkasten}
...
\vspace{0.3em}
\textbf{Beobachtung:} Der schwere Wagen beschleunigt \lsg{langsamer}.

\vspace{0.3em}
\textbf{Erkenntnis:} Je größer die \textbf{Masse}, desto \lsg{kleiner} die Beschleunigung.
\end{merkkasten}
...
\hspace{2em}Mathematisch: $a \sim F$ \quad {\small(a ist \lsg{proportional} zu F)}

\vspace{0.4em}
\textbf{Aus Kasten 2b:} Mehr Masse $\rightarrow$ weniger Beschleunigung

\hspace{2em}Mathematisch: $a \sim \dfrac{1}{m}$ \quad {\small(a ist \lsg{umgekehrt} proportional zu m)}

\vspace{0.5em}
\hrule
\vspace{0.5em}

\textbf{Beide zusammen:} \quad $a = \dfrac{F}{m}$ \quad $\Rightarrow$ \quad umgestellt: \quad $F = $ \lsg{m $\cdot$ a}
\end{merkkasten}
...
\vspace{0.5em}
\begin{tabular}{lll}
\textbf{F} = & \lsg{Kraft} & Einheit: \lsg{Newton (N)} \\[0.5em]
\textbf{m} = & \lsg{Masse} & Einheit: \lsg{Kilogramm (kg)} \\[0.5em]
\textbf{a} = & \lsg{Beschleunigung} & Einheit: \lsg{m/s²} \\
\end{tabular}
\end{center}
\end{formelkasten}
...
\begin{teil}
    ...
    \vspace{0.3em}
    $m = $ \lsg{50 N / 5 m/s²} $= $ \lsg{10 kg}

    \item $F = 200\,$N, $a = 10\,\text{m/s}^2$

    \vspace{0.3em}
    $m = $ \lsg{200 N / 10 m/s²} $= $ \lsg{20 kg}

    \item $F = 400\,$N, $a = 8\,\text{m/s}^2$

    \vspace{0.3em}
    $m = $ \lsg{400 N / 8 m/s²} $= $ \lsg{50 kg}
\end{teil}
...
\begin{teil}
    ...
    \vspace{0.3em}
    $a = $ \lsg{10 N / 2 kg} $= $ \lsg{5 m/s²}

    \item $F = 100\,$N, $m = 20\,$kg

    \vspace{0.3em}
    $a = $ \lsg{100 N / 20 kg} $= $ \lsg{5 m/s²}

    \item Ein Motorrad ($m = 200\,$kg) wird mit $F = 1000\,$N beschleunigt.

    \vspace{0.3em}
    $a = $ \lsg{1000 N / 200 kg} $= $ \lsg{5 m/s²}
\end{teil}
...
\begin{teil}
    ...
    \vspace{0.3em}
    $F_{\text{res}} = F_{\text{Motor}} - F_{\text{Reib}} = $ \lsg{3000 N $-$ 500 N} $= $ \lsg{2500 N}

    \item \operator{Berechne} die Beschleunigung des Autos.

    \vspace{0.3em}
    $a = \dfrac{F_{\text{res}}}{m} = $ \lsg{2500 N / 500 kg} $= $ \lsg{5 m/s²}

    \item \operator{Erkläre}, warum das Auto beschleunigt (nicht bremst).

    \lsg{Die Motorkraft (3000 N) ist größer als die Reibungskraft (500 N). Die resultierende Kraft zeigt nach vorne, also beschleunigt das Auto vorwärts.}
\end{teil}
...
\begin{teil}
    ...
    \vspace{0.3em}
    $F_{\text{links}} = $ \lsg{800 N}, \quad $F_{\text{rechts}} = $ \lsg{900 N}

    \vspace{0.3em}
    $F_{\text{res}} = $ \lsg{900 N $-$ 800 N = 100 N} Richtung: \lsg{rechts}

    \item Wenn das Seil mit beiden Teams $m = 100\,$kg wiegt: Wie groß ist die Beschleunigung?

    \vspace{0.3em}
    $a = $ \lsg{100 N / 100 kg} $= $ \lsg{1 m/s²}
\end{teil}
...
\hfill\textbf{Punkte:} \lsg{28} / \maxpunkte
