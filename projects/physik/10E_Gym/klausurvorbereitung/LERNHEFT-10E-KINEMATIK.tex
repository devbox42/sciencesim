...
\begin{center}
{\large $v(t) = a \cdot t + v_0$}

\vspace{0.5em}

{\large $s(t) = \dfrac{1}{2} a \cdot t^2 + v_0 \cdot t + s_0$}
\end{center}
\small\textit{Reihenfolge: beschleunigt ($\frac{1}{2}at^2$) → gleichförmig ($v_0 t$) → konstant ($s_0$)}
\end{formelbox}
...
\begin{center}
$v(t) = -g \cdot t + v_0$ \hspace{2cm} $h(t) = -\dfrac{1}{2} g \cdot t^2 + v_0 \cdot t$
\end{center}
...
\begin{tabular}{|c|c|}
\hline
$v(t) = a \cdot t + v_0$ & $s(t) = \dfrac{1}{2} a \cdot t^2 + v_0 \cdot t + s_0$ \\
\hline
\end{tabular}
\end{center}
\end{formelbox}
