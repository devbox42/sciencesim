% QR-CODE: Lernpfad Gleichstrommotor (Kl. 9, DS 09a)
...
\newcommand{\lpurl}{https://devbox42.github.io/sciencesim/physik/kl09/motor-induktion/LP-09a-gleichstrommotor.html}
\newcommand{\lpurlkurz}{devbox42.github.io/.../LP-09a-gleichstrommotor.html}
...
\fcolorbox{fachfarbe}{fachfarbe!10}{%
    \parbox{0.7\textwidth}{%
        \centering
        \vspace{3mm}
        {\large Kompakte Einführung zum Gleichstrommotor}\\[2mm]
        5 Schritte -- ca. 12 Minuten
        \vspace{3mm}
    }%
}
