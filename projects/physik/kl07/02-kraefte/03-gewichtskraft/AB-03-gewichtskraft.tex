% ═══════════════════════════════════════════════════════════════
% ARBEITSBLATT: Die Gewichtskraft (UE 3)
...
% Differenzierung anzeigen (Kl. 7) - ausgeschaltet auf Wunsch
...
\vspace{-0.5em}
Die \textbf{Masse} $m$ gibt an, wie viel \luecke{2cm} in einem Körper enthalten ist.

\vspace{0.3em}
\begin{tabular}{@{}ll@{}}
\textbf{Formelzeichen:} & $m$ \\
\textbf{Einheit:} & \luecke{1.5cm} (Kilogramm) \\
\textbf{Wichtig:} & Die Masse ist \luecke{3cm}, das bedeutet, \\
...
Die \textbf{Gewichtskraft} $F_G$ ist die Kraft, mit der ein Himmelskörper (z.\,B. die Erde) einen Körper \luecke{2cm}.
...
\vspace{0.3em}
\begin{tabular}{@{}r@{ = }l@{}}
$F_G$ & Gewichtskraft in \luecke{1.2cm} \\
$m$   & Masse in \si{\kilogram} \\
$g$   & Ortsfaktor in \luecke{1.5cm}
\end{tabular}
\end{minipage}
\hfill
...
\vspace{0.2em}
\begin{teil}
    \item $m = \SI{5}{\kilogram}$ \hfill $F_G = $ \luecke{5cm} $= $ \luecke{2cm}
    \item $m = \SI{8}{\kilogram}$ \hfill $F_G = $ \luecke{5cm} $= $ \luecke{2cm}
\end{teil}
...
\vspace{0.2em}
\begin{teil}
    \item $m = \SI{200}{\gram}$ \hfill $F_G = $ \luecke{2cm}
    \item $m = \SI{500}{\gram}$ \hfill $F_G = $ \luecke{2cm}
    \item $m = \SI{1}{\kilogram} = \SI{1000}{\gram}$ \hfill $F_G = $ \luecke{2cm}
\end{teil}
...
\vspace{0.2em}
\begin{teil}
    \item $m = \SI{2,5}{\kilogram}$ \hfill $F_G = $ \luecke{5cm} $= $ \luecke{2cm}
    \item $m = \SI{0,4}{\kilogram}$ \hfill $F_G = $ \luecke{5cm} $= $ \luecke{2cm}
\end{teil}
...
\vspace{0.2em}
\begin{teil}
    \item $F_G = \SI{40}{\newton}$ \hfill $m = $ \luecke{5cm} $= $ \luecke{2cm}
    \item $F_G = \SI{150}{\newton}$ \hfill $m = $ \luecke{5cm} $= $ \luecke{2cm}
\end{teil}
