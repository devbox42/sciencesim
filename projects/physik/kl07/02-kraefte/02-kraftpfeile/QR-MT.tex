% ═══════════════════════════════════════════════════════════════════════════
% QR-CODE: Stundenleistung Kräfte zusammensetzen (UE 2)
...
\newcommand{\mturl}{https://devbox42.github.io/sciencesim/physik/kl7/kraft/02-kraft-groesse/MT.html}
\newcommand{\mturlkurz}{devbox42.github.io/.../02-kraft-groesse/MT.html}
...
\fcolorbox{warning}{warning!10}{%
    \parbox{0.7\textwidth}{%
        \centering
        \vspace{3mm}
        {\large\bfseries 30 Minuten Zeit!}\\[2mm]
