...
% ARBEITSPFAD-konform: Reihenfolge entspricht LP
% ============================================================================
...
{\small Physik Klasse 7 | Begleitend zum Lernpfad}
\end{center}
...
% ==================== 1. KRAFTPFEIL (LP Schritt 1) ====================
\textbf{1. Der Kraftpfeil} \abmark{Aufgabe 5}

Ein Kraftpfeil hat drei Eigenschaften:
\begin{enumerate}
    \item \textbf{Angriffspunkt} – Wo greift die Kraft an?
    \item \textbf{Richtung} – Wohin zeigt die Kraft?
    \item \textbf{Betrag/Länge} – Wie groß ist die Kraft?
\end{enumerate}
...
% ==================== 2. MASSSTAB (LP Schritt 2) ====================
\textbf{2. Maßstab \& Zeichentipps} \abmark{Aufgabe 1}
...
\begin{tikzpicture}[scale=0.45]
    % RICHTIG
    \node[anchor=east, font=\scriptsize\bfseries, text=green!50!black] at (0,1) {$\checkmark$};
    \draw[green!50!black, thick, ->] (0.3,1) -- (4.3,1);
    \draw[gray, thin] (0.3,0.4) -- (0.3,0.6) -- (4.3,0.6) -- (4.3,0.4);
    \node[font=\tiny, gray] at (2.3,0.2) {4 cm};
    % FALSCH
    \node[anchor=east, font=\scriptsize\bfseries, text=red!70!black] at (0,-0.5) {$\times$};
    \draw[red!70!black, thick] (0.3,-0.5) -- (4.3,-0.5);
    \draw[red!70!black, thick, ->] (4.3,-0.5) -- (5,-0.5);
    \node[font=\tiny, red!70!black] at (2.6,-1) {zu lang!};
\end{tikzpicture}
\end{center}
}}
...
% ==================== 3. GLEICHE RICHTUNG (LP Schritt 3) ====================
\textbf{3. Kräfte in gleicher Richtung} \abmark{Aufgabe 2}
...
% ==================== 4. ENTGEGENGESETZT (LP Schritt 4) ====================
\textbf{4. Entgegengesetzte Kräfte} \abmark{Aufgabe 3}
...
% ==================== 5. GLEICHGEWICHT (LP Schritt 5) ====================
\textbf{5. Kräftegleichgewicht} \abmark{Aufgabe 4}
