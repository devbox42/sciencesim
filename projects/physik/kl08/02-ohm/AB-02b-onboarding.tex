% ═══════════════════════════════════════════════════════════════
% AB-02b: Onboarding Widerstände (Reihenschaltung)
% Physik Klasse 8 | Doppelstunde 02b
% Kurzes Arbeitsblatt zur Wiederholung + R in Reihenschaltung
% ═══════════════════════════════════════════════════════════════
...
\begin{itemize}[leftmargin=1.5em, itemsep=2pt]
    \item $R = $ \luecke{1.5cm} (Widerstand)
    \item $U = $ \luecke{1.5cm} (Spannung)
    \item $I = $ \luecke{1.5cm} (Stromstärke)
\end{itemize}
