...
% Version 3.0 – LP-basiert, keine Formeln vorgegeben
% ═══════════════════════════════════════════════════════════════
...
\begin{center}
{\large\bfseries Arbeitsblatt: \thema}
\end{center}
...
\textbf{Horizontal:} & \luecke{3.8cm} \\[8pt]
\textbf{Vertikal:} & \luecke{3.8cm} \\
\end{tabular}

\vspace{6pt}
Die horizontale Geschwindigkeit beeinflusst die \luecke{2cm} \textbf{nicht}.

\vspace{4pt}
Deshalb landen Fallball und Wurfball \luecke{2.5cm}.
\end{merkbox}
...
\textbf{a)} Fallzeit $t = $ \luecke{2cm} \hfill\textcolor{grau}{\small/2}

\textbf{b)} Wurfweite $s_x = $ \luecke{2cm} \hfill\textcolor{grau}{\small/2}

\textbf{c)} Vertikale Aufprallgeschwindigkeit $v_y = $ \luecke{2cm} \hfill\textcolor{grau}{\small/2}

\textbf{d)} Resultierende Aufprallgeschwindigkeit $v_{\text{res}} = $ \luecke{2cm} \hfill\textcolor{grau}{\small/2}

\textbf{e)} Aufprallwinkel $\alpha = $ \luecke{2cm} \hfill\textcolor{grau}{\small/2}
...
Ein Paket fällt $t = 4\,\text{s}$ lang und landet $s_x = 100\,\text{m}$ vom Abwurfpunkt entfernt.
...
$v_1 \approx$ \luecke{1.5cm} km/s \quad (Kreisbahn um die Erde)

\vspace{6pt}
\textbf{Zweite kosmische Geschwindigkeit:}

$v_2 \approx$ \luecke{1.5cm} km/s \quad (Flucht aus Erdanziehung)
\end{merkbox}
...
$\square$ Überlagerungsprinzip \quad
$\square$ Fallzeit ($t$) \quad
$\square$ Wurfweite ($s_x$) \quad
$\square$ Aufprallgeschw. ($v_{\text{res}}$) \quad
$\square$ Aufprallwinkel ($\alpha$)
...
\begin{tabular}{llll}
\textbf{Gesamt:} & \luecke{1cm} / \gesamt{} BE &
\textbf{NP:} & \luecke{2cm}
\end{tabular}
