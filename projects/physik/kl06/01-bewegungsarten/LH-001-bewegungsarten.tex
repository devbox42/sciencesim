...
\begin{itemize}[itemsep=1pt]
    \item Zug auf gerader Strecke: geradlinig, gleichförmig
    \item Karussell: krummlinig, gleichförmig
    \item Auto beim Bremsen: geradlinig, ungleichförmig
    \item Uhrzeiger: krummlinig, gleichförmig
    \item Rolltreppe: geradlinig, gleichförmig
    \item Achterbahn: krummlinig, ungleichförmig
    \item Ball rollt aus: geradlinig, ungleichförmig
    \item Riesenrad: krummlinig, gleichförmig
\end{itemize}

\textbf{Q5 Lösungen (**)}:
\begin{itemize}[itemsep=1pt]
    \item Aufzug bei voller Fahrt: geradlinig, gleichförmig
    \item Schaukel: krummlinig, ungleichförmig
    \item Fallschirmspringer (gleiten): krummlinig, gleichförmig
\end{itemize}

\textbf{Q6 Lösungen (***)}:
\begin{itemize}[itemsep=1pt]
    \item Fußball beim Schuss: krummlinig, ungleichförmig
