% ═══════════════════════════════════════════════════════════════
% MUSTERLÖSUNG - Physik Klasse 6: Bewegungsarten erkennen
% Stunde 1 von 4 | Lösungen in ROT
% ═══════════════════════════════════════════════════════════════
...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\small\textcolor{physik}{\textbf{Physik}} | Bewegungsarten -- \textcolor{loesung}{\textbf{MUSTERLÖSUNG}}}
...
Ein Körper ist in \textbf{Bewegung}, wenn er seinen \lsg{Ort} verändert.

Wir beschreiben Bewegungen mit zwei Eigenschaften:
\begin{itemize}[leftmargin=1.5em, itemsep=1pt]
    \item Die \textbf{Bahnform} beschreibt, wie der \lsg{Weg} aussieht.
    \item Die \textbf{Bewegungsart} beschreibt, ob sich die \lsg{Geschwindigkeit} ändert.
\end{itemize}
\end{merkkasten}
...
\begin{itemize}[leftmargin=1.5em, itemsep=2pt]
    \item \textbf{Geradlinig:} Der Körper bewegt sich auf einer \lsg{geraden Linie}.
    \item \textbf{Krummlinig:} Der Körper bewegt sich auf einer \lsg{gekrümmten} Bahn.
\end{itemize}

\textit{Sonderfall:} Die \textbf{kreisförmige} Bewegung ist eine spezielle krummlinige Bewegung -- der Körper bewegt sich auf einem \lsg{Kreis}.
\end{merkkasten}
...
\begin{itemize}[leftmargin=1.5em, itemsep=2pt]
    \item \textbf{Gleichförmig:} Die Geschwindigkeit bleibt \lsg{gleich}.
    \item \textbf{Ungleichförmig:} Die Geschwindigkeit \lsg{ändert} sich.
\end{itemize}
\textit{Beispiele für ungleichförmig:} Anfahren, Bremsen, Beschleunigen
\end{merkkasten}

% ═══════════════════════════════════════════════════════════════
% SEITE 2: ANWENDUNG MIT LÖSUNGEN
% ═══════════════════════════════════════════════════════════════
...
\hline
a) Rolltreppe & \lsg{$\boxtimes$} & $\square$ & \lsg{$\boxtimes$} & $\square$ \\
\hline
b) Schaukel & $\square$ & \lsg{$\boxtimes$} & $\square$ & \lsg{$\boxtimes$} \\
\hline
c) Aufzug (volle Fahrt) & \lsg{$\boxtimes$} & $\square$ & \lsg{$\boxtimes$} & $\square$ \\
\hline
d) Fußball beim Schuss & $\square$ & \lsg{$\boxtimes$} & $\square$ & \lsg{$\boxtimes$} \\
\hline
\end{tabular}
\end{center}
