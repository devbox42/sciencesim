...
% ============================================================================
\begin{center}
    {\Large\bfseries\textcolor{physik}{Weg-Zeit-Diagramme verstehen}}\\[0.2em]
...
\begin{itemize}[leftmargin=*, itemsep=3pt, topsep=0pt]
    \item Die \textbf{waagerechte Achse} (x-Achse) zeigt die \lueckelsg{Zeit}~$t$ in \lueckelsg{s}.
    \item Die \textbf{senkrechte Achse} (y-Achse) zeigt den \lueckelsg{Weg}~$s$ in \lueckelsg{m}.
\end{itemize}
\end{minipage}
\hfill
...
\begin{itemize}[leftmargin=*, itemsep=2pt, topsep=3pt]
    \item \textbf{Steile} Gerade = \lueckelsg{schnelle} Bewegung
    \item \textbf{Flache} Gerade = \lueckelsg{langsame} Bewegung
\end{itemize}
\end{minipage}
\hfill
\begin{minipage}[t]{0.40\textwidth}
...
\begin{tikzpicture}[scale=0.38]
    ...
    \begin{scope}[shift={(0,0)}]
        ...
        \node[below, loesung] at (2,-2.2) {\tiny = \textbf{schnell}};
    \end{scope}
    % Diagramm 2: Langsam
    \begin{scope}[shift={(7.5,0)}]
        ...
        \node[below, loesung] at (2,-2.2) {\tiny = \textbf{langsam}};
    \end{scope}
    ...
    \begin{scope}[shift={(15,0)}]
        ...
        \node[below, loesung] at (2,-2.2) {\tiny = \textbf{Stillstand}};
    \end{scope}
    ...
    \begin{scope}[shift={(22.5,0)}]
        ...
        \node[below, loesung] at (2,-2.2) {\tiny = \textbf{ungleichf.}};
    \end{scope}
\end{tikzpicture}
\end{center}
\end{merkkasten}
...
\begin{tikzpicture}[scale=0.7]
    ...
    \draw[dashed, loesung] (4,0) -- (4,2) -- (0,2);
    \draw[dashed, loesung] (6,0) -- (6,3) -- (0,3);
    \draw[dashed, loesung] (8,0) -- (8,4) -- (0,4);
\end{tikzpicture}
\end{minipage}
\hfill
...
\begin{enumerate}[label=\alph*), leftmargin=1.5em, itemsep=0.6em]
    \item Weg nach $t = 4$ s? \quad $s =$ \lueckelsg{20 m}
    \item Zeit bei $s = 30$ m? \quad $t =$ \lueckelsg{6 s}
    \item Weg nach $t = 8$ s? \quad $s =$ \lueckelsg{40 m}
\end{enumerate}
\end{minipage}
...
\begin{tikzpicture}[scale=0.68]
    ...
    % LÖSUNG
    \draw[very thick, loesung] (0,0) -- (16,8);
    \fill[loesung] (0,0) circle (3pt);
    \fill[loesung] (4,2) circle (3pt);
    \fill[loesung] (8,4) circle (3pt);
    \fill[loesung] (12,6) circle (3pt);
    \fill[loesung] (16,8) circle (3pt);
\end{tikzpicture}
\end{center}
...
\begin{tikzpicture}[scale=0.35]
    ...
    % Lösungs-Beschriftungen
    \node[loesung] at (1.2,1.5) {\tiny schnell};
    \node[loesung] at (3.6,2.8) {\tiny Stillst.};
    \node[loesung] at (6.4,3.3) {\tiny langs.};
\end{tikzpicture}

\vspace{0.2em}
{\footnotesize
1: \lsg{schnelle gleichf. Bewegung}\\[0.3em]
2: \lsg{Stillstand}\\[0.3em]
3: \lsg{langsame gleichf. Bewegung}
}
\end{minipage}
\hfill
\begin{minipage}[t]{0.48\textwidth}
...
\vspace{0.2em}
{\footnotesize
A: $\square$ gleichförmig \quad \lsg{$\boxtimes$ Stillstand}\\[0.3em]
B: \lsg{$\boxtimes$ gleichförmig} \quad $\square$ Stillstand
}
\end{minipage}
