% ═══════════════════════════════════════════════════════════════════════════
% QR-CODE: Lernpfad Geschwindigkeit (Kl. 6)
% ═══════════════════════════════════════════════════════════════════════════
...
% Konfiguration
\newcommand{\lptitel}{Geschwindigkeit}
...
\newcommand{\lpurlkurz}{devbox42.github.io/.../std-02-geschwindigkeit/LP-02-geschwindigkeit.html}
...
\fcolorbox{fachfarbe}{fachfarbe!10}{%
    \parbox{0.7\textwidth}{%
        ...
        Halte dein Arbeitsblatt bereit!
        \vspace{3mm}
    }%
}
