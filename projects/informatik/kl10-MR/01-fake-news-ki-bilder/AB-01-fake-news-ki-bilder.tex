...
\hline
\textbf{Name:} \hspace{5cm} & \textbf{Datum:} \hspace{3cm} \\[4mm]
\hline
\end{tabularx}
...
\begin{tikzpicture}
\fill[hintergrund] (0,0) rectangle (\linewidth, 18mm);
\draw[informatik, thick] (0,0) rectangle (\linewidth, 18mm);
\node[anchor=west, font=\bfseries] at (3mm, 14mm) {Selbsteinschätzung:};
\node[anchor=west, font=\small] at (3mm, 8mm) {\checkbox Ich kann erklären, was Fake News sind.};
\node[anchor=west, font=\small] at (3mm, 3mm) {\checkbox Ich kann KI-generierte Bilder an typischen Fehlern erkennen.};
\node[anchor=west, font=\small] at (85mm, 8mm) {\checkbox Ich kann die CRAAP-Methode anwenden.};
\node[anchor=west, font=\small] at (85mm, 3mm) {\checkbox Ich habe ein Fake-Beispiel gefunden.};
\end{tikzpicture}
